...
<head>
    ...
    <title>GBT KRISTUS JURUSELAMAT - @yield('title')</title>
...
<body id="page-top">
    ...
    @else
        @if (Auth::user()->level == 'Admin' || Auth::user()->level == 'Pendeta')
            <!-- Page Wrapper -->
            <div id="wrapper">
                <!-- Sidebar -->
                ...
                <nav class="navbar navbar-expand navbar-light topbar mb-4">
                    <div class="container">
                        <a class="title" href="{{ url('/') }}">
                            ...
                            <div class="title-text mx-3">GBT KRISTUS JURUSELAMAT</div>
                        </a>
                        <!-- Topbar Navbar -->
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    @if (Auth::user()->level == 'Penumpang')
                                        <a class="dropdown-item" href="{{ route('pemesanan.list') }}">
