                                ...
                                <div class="card o-hidden border-0 shadow h-100">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col font-weight-bold h5" style="margin: 0; color: #000;">
                                                {{ $data->rute->start }}<i class="fas fa-long-arrow-alt-right mx-2"
                                                    style="color: #858796;"></i>{{ $data->rute->end }}
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <p style="margin: 0; color:#000;">
                                            {{ date('l, d F Y H:i', strtotime($data->waktu)) }} WIB</p>
                                        <p style="margin: 0; color:#000;">{{ $data->rute->transportasi->name }}
                                            ({{ $data->nama_acara }})</p>
                                    </div>
                                </div>
                        </a>
