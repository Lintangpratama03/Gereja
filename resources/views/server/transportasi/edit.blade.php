            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                        value="{{ $transportasi->name }}" required readonly />
                </div>
                <div class="form-group">
                    <label for="kode">Kode</label>
                    <input type="text" class="form-control" id="kode" name="kode"
                        value="{{ $transportasi->kode }}" required />
                </div>
                <div class="form-group">
                    <label for="jumlah">Jumlah Kursi</label>
                    <input type="text" class="form-control" id="jumlah" name="jumlah"
                        onkeypress="return inputNumber(event)" value="{{ $transportasi->jumlah }}" required />
                </div>
                <div class="form-group">
                    ...
                    <select class="select2 form-control" id="category_id" name="category_id" required
                        ...
                        @foreach ($category as $data)
                            <option value="{{ $data->id }}" @if ($data->id == $transportasi->category_id) selected @endif>
                                {{ $data->name }}</option>
                        @endforeach
                    </select>
                </div>
