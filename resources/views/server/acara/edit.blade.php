    ...
    <div class="card shadow mb-4 mt-2">
        <form action="{{ route('rute.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="harga" name="harga"
                        onkeypress="return inputNumber(event)" value="{{ $rute->harga }}" required readonly />
                </div>
                <div class="form-group">
                    ...
                    <select class="select2 form-control" id="transportasi_id" name="transportasi_id" required
                        style="width: 100%; color: #6e707e;" disabled>
            ...
            <div class="card-footer">
                <a href="{{ route('list.index') }}" class="btn btn-warning mr-2">Kembali</a>
